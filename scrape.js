    ...
    request(repUrl, (repContainer) => {
      ...
      request(finRepUrl, (finRepContainer) => {
        ...
        if (cur && prev) {
          ...
          if (isFinite(data['財務状況']['昨年度']['一株利益']) && isFinite(data['財務状況']['昨年度']['一株配当'])) {
            data['財務状況']['昨年度']['配当性向'] = sbiRound(data['財務状況']['昨年度']['一株配当'] / data['財務状況']['昨年度']['一株利益'] * 100);
          } else {
            data['財務状況']['昨年度']['配当性向'] = '-';
          }
          ...
          if (isFinite(data['財務状況']['本年度']['予想一株利益']) && isFinite(data['財務状況']['本年度']['予想一株配当'])) {
            data['財務状況']['本年度']['予想配当性向'] = sbiRound(data['財務状況']['本年度']['予想一株配当'] / data['財務状況']['本年度']['予想一株利益'] * 100);
          } else {
            data['財務状況']['本年度']['予想配当性向'] = '-';
          }
        }
